...
export default function SACSAT(props) {
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "SACSAT")}
      {...rest}
    >
      <SelectField
        label="Immersion Day Program"
      ...
      >
        <option
          children="Standard Immersion Day"
          value="Standard Immersion Day"
          {...getOverrideProps(overrides, "Field0option0")}
        ></option>
        <option
          children="Solutions-Focused/Multi-Customer Immersion Day"
          value="Solutions-Focused/Multi-Customer Immersion Day"
